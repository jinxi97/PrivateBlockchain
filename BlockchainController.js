        ...
        this.app.get("/block/:height", async (req, res) => {
            if(req.params.height) {
                ...
                if(block){
                    ...
                    return res.status(404).send("Block Not Found! By height");
                }
            } else {
        ...
        this.app.get("/block/:hash", async (req, res) => {
            if(req.params.hash) {
                ...
                if(block){
                    ...
                    return res.status(404).send("Block Not Found! By hash");
                }
            } else {
                return res.status(404).send("Block Not Found! Review the Parameters!");
            }
            ...
            if(req.params.address) {
                ...
                try {
                    ...
                    if(stars){
                        ...
                        return res.status(404).send("Block Not Found! By address");
                    }
                } catch (error) {
                    return res.status(500).send(error);
                }
